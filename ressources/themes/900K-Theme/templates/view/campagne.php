<div class="conceptions" >
  <div class="conceptions--title" style="background-image : url('<?= IMAGES_URL; ?>/conceptions.png')">
    <h1>Vous êtes victime de vos  <span>préjugés<span></h1>
...
Voilà pourquoi nous ne sommes capables de voir le handicap qu'à travers le prisme de notre réalité et donc de nos stéréotypes.</p>
  ...
  <div class="conceptions__vdo">
    <div class="conceptions__vdo--content">
      <p>Découvrez la vidéo explicative de
Patrick Scharnitzk, docteur et manager chargé d'accompagner les entreprises sur les stéréotypes en entreprise.</p>
    </div>
  ...
  <div class="conceptions--content">
    <p>Bon, vous avez pris conscience que nous avons tous des stéréotypes existants envers les personnes en situation de handicap et vous savez à présent qu’ils sont dus à un processus inconscient. </p>
  </div>
    ...
    <div class="conceptions__articles" style="background-image:url('<?= IMAGES_URL; ?>/art1.png')">
      <div class="conceptions__articles--content--wraper">
        <div class="conceptions__articles--content">
          <p>Apporter une valeur ajoutée à votre
entreprise et faire valoir votre RSE grâce à l’embauche d’employés atteint de handicap  </p>
        </div>
        <a href="http://sircome.fr/handicap-et-responsabilite-sociale-des-entreprises/" target="_blank">
          <button class="mdc-button mdc-button--raised mdc-ripple-upgraded">
            En savoir plus
    ...
    <div class="conceptions__articles" style="background-image:url('<?= IMAGES_URL; ?>/art2.png')">
      <div class="conceptions__articles--content--wraper">
        <div class="conceptions__articles--content">
          <p>Pôle Emploi et Cap emploi mettent en lien personnes handicapées et entreprise </p>
        </div>
