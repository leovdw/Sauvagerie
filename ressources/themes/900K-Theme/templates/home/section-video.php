...
<div class="home__video--section">
  <div class="home__video--wraper">
    ...
    <div class="home__video">
      <iframe width="350" height="350" src="https://www.youtube-nocookie.com/embed/brfdSvQN3Sc?controls=0&rel=0&autoplay=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      <a href="<?= $home_btn['url']; ?>">
